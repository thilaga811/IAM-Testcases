...
public class TC_05_Leaving_createdBy_feild extends base{
	@SuppressWarnings("unchecked")
	@BeforeClass
	public void saveSecurityQues() throws Throwable
	{
		saveSecQueswithoutCreatedBy();
	...
	@Test
	public void TC__05_saveSecurityAns_leaving_createdBy_feild() {
		String responseBody = response.getBody().asString();
		//test.log(LogStatus.INFO, "Response Body is==> " + responseBody);
		 logger.info("Response Body is==> " + responseBody);
		//Assert.assertEquals(responseBody.contains("SECURITY_QUES_ANS_MANDATORY\",\"SECURITY_QUES_KEY_MANDATORY\",\"SECURITY_QUES_ANS_MANDATORY\",\"SECURITY_QUES_KEY_MANDATORY\",\"SECURITY_QUES_ANS_MANDATORY\",\"SECURITY_QUES_KEY_MANDATORY\",\"SECURITY_QUES_ANS_MANDATORY\",\"SECURITY_QUES_KEY_MANDATORY\",\"SECURITY_QUES_ANS_MANDATORY\",\"SECURITY_QUES_KEY_MANDATORY"), true);
