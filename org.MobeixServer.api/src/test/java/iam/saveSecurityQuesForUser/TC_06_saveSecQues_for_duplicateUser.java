...
public class TC_06_saveSecQues_for_duplicateUser extends base{
	...
	@Test
	public void TC__06_saveSecurityQues_for_duplicate_User() {
		String responseBody = response.getBody().asString();
		//test.log(LogStatus.INFO, "Response Body is==> " + responseBody);
		 logger.info("Response Body is==> " + responseBody);
		Assert.assertEquals(responseBody.contains("SEC_QUES_ALREADY_CONFIGURED"), true);
